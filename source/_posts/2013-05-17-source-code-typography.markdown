...
A designer friend recommended ["The Elements of Typographic Style"][elements], by Robert Bringhirst.  This is "The Art of Computer Programming" for typography.  Very early in the book, Bringhirst has this to say:
